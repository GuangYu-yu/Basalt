...
LANDSCAPE_API_READY_TIMEOUT="${LANDSCAPE_API_READY_TIMEOUT:-120}"
LANDSCAPE_API_READY_INTERVAL="${LANDSCAPE_API_READY_INTERVAL:-3}"
LANDSCAPE_ROUTER_READY_TIMEOUT="${LANDSCAPE_ROUTER_READY_TIMEOUT:-300}"
...
LANDSCAPE_TEST_RESOURCE_LOCK="${LANDSCAPE_TEST_RESOURCE_LOCK:-/tmp/basalt-test-resources.lock}"
...
# 从构建配置读取默认 Landscape 版本（build.env 为单一事实）
